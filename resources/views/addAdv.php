...
<html>
  ...
  <body>
    ...
    <section class="site-hero overlay" style="background-image: url(images/bg-1.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade-up">
            <form style="width: 26rem;">
                ...
                <div data-mdb-input-init class="rounded form-outline mb-1">
                  <input type="file" multiple id="form4Example1" class="form-control" placeholder="Share pictures of the most unforgottable moments"/>
                </div>
                ...
                <!-- Submit button -->
                <button data-mdb-ripple-init type="button" class="rounded btn btn-primary btn-block mb-4">Send</button>
            </form>
          </div>
        </div>
      </div>
